describe('Recurrence Calculator Tests', function(){
    ...
    it('does not return occurrence on the same day as startDate', inject(function(recurrenceCalculator) {
    ...
    it('returns `1W Wed` occurrence correctly', inject(function(recurrenceCalculator) {
        var startDate = moment({year:2015, month: 9, day: 7});
        var nextRunDate = recurrenceCalculator.getNewRunDate(startDate, '1W Wed');
    ...
    it('returns `2W Wed` occurrence correctly', inject(function(recurrenceCalculator) {
        var startDate = moment({year:2015, month: 9, day: 7});
    ...
    it('returns `1M 3` occurrence correctly', inject(function(recurrenceCalculator) {
